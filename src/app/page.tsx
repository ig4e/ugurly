  ...
  return (
    <main className="flex h-full flex-col items-center">
      <div className="overflow-hidden">
        ...
        <div className="animate-cardlight absolute inset-x-0 top-0 -z-[10] min-h-[40vh] rounded-b-full bg-gradient-to-b from-rose-500 to-red-100 opacity-80 blur-3xl dark:from-rose-900 md:min-h-[60vh]" />
        <div
